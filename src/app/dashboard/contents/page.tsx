...
import ContentHeader from "@/components/layout/Header/components/ContentHeader";
...
export default function ContentsPage() {
  ...
  return (
    <>
      <ContentHeader setIsModalOpen={setIsModalOpen} />

      {/* Header ile içerik arasında ufak boşluk */}
      <div className="mt-8" />

      {/* Dashboard Stats */}
      <DashboardStats />

      {/* Grid / List Toggle & Takvim Linki */}
