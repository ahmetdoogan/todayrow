        ...
        <div className="p-6">
          ...
          <div className="flex justify-end gap-2 mt-8">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-red-600 bg-red-50 rounded-lg hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/40 transition-colors text-sm"
            >
              <Trash2 size={16} />
              {tCommon('delete')}
            </button>
            ...
            {!selectedPlan.is_completed && (
              <>
                <button 
                  onClick={handleEdit}
                  className="flex items-center gap-2 px-4 py-2 text-slate-700 bg-slate-100 rounded-lg hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 transition-colors text-sm"
                >
                  <Edit2 size={16} />
                  {tCommon('edit')}
                </button>
