    ...
    <section className="py-10 md:py-20 px-4 md:px-8 bg-white dark:bg-[#111111] overflow-hidden relative">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="relative flex flex-col md:flex-row items-start gap-8 md:gap-12 p-6 md:p-10 border border-gray-200 dark:border-gray-800 rounded-2xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800"
        >
